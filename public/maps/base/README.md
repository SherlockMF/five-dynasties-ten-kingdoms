...
`east-asia-z7.pmtiles` 是网站 943 年地图使用的同源静态矢量底图。浏览器从本站 `/maps/base/east-asia-z7.pmtiles` 发起 Range 请求，不再依赖缺少跨域响应头的远程归档。

## 来源与范围

- 原始归档：`https://build.protomaps.com/20231023.pmtiles`
- 数据快照：OpenStreetMap 2023-10-23，并含 Natural Earth 自然地理数据
- 裁剪范围：`72,18,136,55`（WGS84，经度/纬度）
- 缩放级别：`0—7`
...
```powershell
pmtiles extract https://build.protomaps.com/20231023.pmtiles public/maps/base/east-asia-z7.pmtiles --bbox=72,18,136,55 --maxzoom=7 --download-threads=8
...
- 文件大小：`17,441,148` 字节
- SHA-256：`003206bcf9c1bb74833866a86a9b0973064833144bab8ab9e2984b645ef9a5af`
- 格式：PMTiles v3 / MVT / gzip / clustered
- Header：bbox `72,18,136,55`，minzoom `0`，maxzoom `7`
