...
const base = { sourceRefs: ["谭其骧主编《中国历史地图集》第五册（位置参考）", "《考古学视野下的燕云十六州》（州治沿革与现代参照）"], verificationStatus: "illustrative" as const };
...
export const locations: HistoricalLocation[] = [
  ...
  { id: "jizhou", name: "蓟州", longitude: 117.41, latitude: 40.05, modernReference: "今天津蓟州一带", ...base, ...historicalExtension() },
  { id: "yingzhou", name: "瀛州", longitude: 116.1, latitude: 38.45, modernReference: "今河北河间一带；勿与山西应州混同", ...base, ...historicalExtension() },
  { id: "mozhou", name: "莫州", longitude: 116.02, latitude: 38.71, modernReference: "今河北任丘北部一带", ...base, ...historicalExtension() },
  { id: "zhuozhou", name: "涿州", longitude: 115.97, latitude: 39.49, modernReference: "今河北涿州一带", ...base, ...historicalExtension() },
  { id: "tanzhou-yanyun", name: "檀州", longitude: 116.84, latitude: 40.38, modernReference: "今北京密云一带；勿与湖南潭州混同", ...base, ...historicalExtension() },
  { id: "shunzhou", name: "顺州", longitude: 116.65, latitude: 40.13, modernReference: "今北京顺义一带", ...base, ...historicalExtension() },
  { id: "xinzhou", name: "新州", longitude: 115.28, latitude: 40.5, modernReference: "今河北涿鹿一带", ...base, ...historicalExtension() },
  { id: "guizhou", name: "妫州", longitude: 115.52, latitude: 40.41, modernReference: "今河北怀来一带", ...base, ...historicalExtension() },
  { id: "ruzhou", name: "儒州", longitude: 115.97, latitude: 40.46, modernReference: "今北京延庆一带，州治位置为近似参照", ...base, ...historicalExtension() },
  { id: "wuzhou", name: "武州", longitude: 114.72, latitude: 40.68, modernReference: "今河北宣化一带", ...base, ...historicalExtension() },
  { id: "yunzhou", name: "云州", longitude: 113.3, latitude: 40.08, modernReference: "今山西大同一带", ...base, ...historicalExtension() },
  { id: "yingzhou-shanxi", name: "应州", longitude: 113.19, latitude: 39.56, modernReference: "今山西应县一带；勿与河北瀛州混同", ...base, ...historicalExtension() },
  { id: "huanzhou", name: "寰州", longitude: 112.68, latitude: 39.35, modernReference: "今山西朔州东北一带，州治位置为近似参照", ...base, ...historicalExtension() },
  { id: "shuozhou", name: "朔州", longitude: 112.43, latitude: 39.33, modernReference: "今山西朔州一带", ...base, ...historicalExtension() },
  { id: "weizhou-yanyun", name: "蔚州", longitude: 114.57, latitude: 39.84, modernReference: "今河北蔚县一带；勿与魏州混同", ...base, ...historicalExtension() },
];
