...
export const regions: HistoricalRegion[] = [
  ...
  region({ dynastyId: "northern-song", validFromYear: 960, validToYearExclusive: 961, labelPoint: [112, 35.5], coordinates: north, ...mixed([6]) }),
  region({ dynastyId: "liao", validFromYear: 916, validToYearExclusive: 961, labelPoint: [116, 41], coordinates: [[109, 39], [119, 38], [124, 42], [121, 45], [111, 45], [109, 39]], ...mixed([3, 4, 5, 6]) }),
  region({ dynastyId: "wuyue", validFromYear: 907, validToYearExclusive: 961, labelPoint: [120, 29], coordinates: [[118, 27], [122, 28], [122, 31], [119, 31], [118, 27]], ...historicalExtension() }),
  region({ dynastyId: "wu", validFromYear: 907, validToYearExclusive: 937, labelPoint: [117, 31], coordinates: [[114, 29], [120, 29], [120, 33], [115, 34], [114, 29]], ...historicalExtension() }),
  region({ dynastyId: "southern-tang", validFromYear: 937, validToYearExclusive: 961, labelPoint: [116, 30.5], coordinates: [[112, 27], [120, 27], [120, 33], [114, 34], [112, 27]], ...historicalExtension() }),
  ...
  region({ dynastyId: "later-shu", validFromYear: 934, validToYearExclusive: 961, labelPoint: [104, 30], coordinates: [[100, 27], [108, 27], [108, 33], [101, 33], [100, 27]], ...historicalExtension() }),
  region({ dynastyId: "southern-han", validFromYear: 917, validToYearExclusive: 961, labelPoint: [111, 23], coordinates: [[106, 20], [116, 20], [116, 25], [107, 25], [106, 20]], ...historicalExtension() }),
  region({ dynastyId: "jingnan", validFromYear: 924, validToYearExclusive: 961, labelPoint: [112, 30], coordinates: [[110, 29], [114, 29], [114, 32], [110, 32], [110, 29]], ...historicalExtension() }),
  region({ dynastyId: "northern-han", validFromYear: 951, validToYearExclusive: 961, labelPoint: [112, 38], coordinates: [[110, 36], [114, 36], [114, 40], [110, 40], [110, 36]], ...mixed([5, 6]) }),
];
