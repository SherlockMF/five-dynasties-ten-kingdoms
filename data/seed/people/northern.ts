...
export const northernPeople: Person[] = [
  {
    id: "huang-chao", name: "黄巢", deathYear: 884, dynastyIds: [], roles: ["唐末起事军领袖", "大齐政权建立者"], roleCategories: ["ruler", "general"],
  ...
  {
    id: "zhu-wen", name: "朱温", birthYear: 852, deathYear: 912, dynastyIds: ["later-liang"], roles: ["后梁建立者", "皇帝", "唐末藩镇"], roleCategories: ["ruler", "general"],
  ...
  {
    id: "zhu-yougui", name: "朱友珪", deathYear: 913, dynastyIds: ["later-liang"], roles: ["后梁皇帝", "朱温之子"], roleCategories: ["ruler"],
  ...
  {
    id: "zhu-youzhen", name: "朱友贞", birthYear: 888, deathYear: 923, dynastyIds: ["later-liang"], roles: ["后梁末帝", "朱温之子"], roleCategories: ["ruler"],
  ...
  {
    id: "jing-xiang", name: "敬翔", deathYear: 923, dynastyIds: ["later-liang"], roles: ["后梁宰相", "谋臣"], roleCategories: ["official"],
  ...
  {
    id: "wang-yanzhang", name: "王彦章", birthYear: 863, deathYear: 923, dynastyIds: ["later-liang"], roles: ["后梁将领"], roleCategories: ["general"],
  ...
  {
    id: "li-keyong", name: "李克用", birthYear: 856, deathYear: 908, dynastyIds: ["later-tang"], roles: ["晋王", "河东节度使", "沙陀军首领"], roleCategories: ["ruler", "general"],
  ...
  {
    id: "li-cunxu", name: "李存勖", birthYear: 885, deathYear: 926, dynastyIds: ["later-tang"], roles: ["后唐建立者", "皇帝", "晋王"], roleCategories: ["ruler", "general"],
  ...
  {
    id: "li-siyuan", name: "李嗣源", birthYear: 867, deathYear: 933, dynastyIds: ["later-tang"], roles: ["后唐皇帝", "将领"], roleCategories: ["ruler", "general"],
  ...
  {
    id: "li-congke", name: "李从珂", birthYear: 885, deathYear: 936, dynastyIds: ["later-tang"], roles: ["后唐末帝", "凤翔节度使"], roleCategories: ["ruler", "general"],
  ...
  {
    id: "guo-chongtao", name: "郭崇韬", deathYear: 926, dynastyIds: ["later-tang"], roles: ["后唐枢密使", "将领"], roleCategories: ["general", "official"],
  ...
  {
    id: "an-chonghui", name: "安重诲", deathYear: 931, dynastyIds: ["later-tang"], roles: ["后唐枢密使", "重臣"], roleCategories: ["official"],
  ...
  {
    id: "feng-dao", name: "冯道", birthYear: 882, deathYear: 954, dynastyIds: ["later-tang", "later-jin", "later-han", "later-zhou"], roles: ["宰相", "文臣"], roleCategories: ["official"],
  ...
  {
    id: "shi-jingtang", name: "石敬瑭", birthYear: 892, deathYear: 942, dynastyIds: ["later-tang", "later-jin"], roles: ["后晋建立者", "皇帝", "河东节度使"], roleCategories: ["ruler", "general"],
  ...
  {
    id: "shi-chonggui", name: "石重贵", birthYear: 914, deathYear: 974, dynastyIds: ["later-jin"], roles: ["后晋末帝", "皇帝"], roleCategories: ["ruler"],
  ...
  {
    id: "sang-weihan", name: "桑维翰", birthYear: 898, deathYear: 947, dynastyIds: ["later-jin"], roles: ["后晋宰相", "谋臣"], roleCategories: ["official"],
  ...
  {
    id: "du-chongwei", name: "杜重威", deathYear: 948, dynastyIds: ["later-jin", "later-han"], roles: ["后晋将领", "天雄军节度使"], roleCategories: ["general"],
  ...
  {
    id: "liu-zhiyuan", name: "刘知远", birthYear: 895, deathYear: 948, dynastyIds: ["later-jin", "later-han"], roles: ["后汉建立者", "皇帝", "河东节度使"], roleCategories: ["ruler", "general"],
  ...
  {
    id: "liu-chengyou", name: "刘承祐", birthYear: 931, deathYear: 951, dynastyIds: ["later-han"], roles: ["后汉隐帝", "皇帝"], roleCategories: ["ruler"],
  ...
  {
    id: "guo-wei", name: "郭威", birthYear: 904, deathYear: 954, dynastyIds: ["later-han", "later-zhou"], roles: ["后周建立者", "皇帝", "枢密使"], roleCategories: ["ruler", "general"],
  ...
  {
    id: "chai-rong", name: "柴荣", birthYear: 921, deathYear: 959, dynastyIds: ["later-zhou"], roles: ["后周皇帝", "改革者", "统帅"], roleCategories: ["ruler", "general"],
  ...
  {
    id: "liu-chong", name: "刘崇", birthYear: 895, deathYear: 954, dynastyIds: ["later-han", "northern-han"], roles: ["北汉建立者", "河东节度使"], roleCategories: ["ruler", "general"],
  ...
  {
    id: "liu-jiyuan", name: "刘继元", deathYear: 992, dynastyIds: ["northern-han", "northern-song"], roles: ["北汉末主", "皇帝"], roleCategories: ["ruler"],
  ...
  {
    id: "zhao-kuangyin", name: "赵匡胤", birthYear: 927, deathYear: 976, dynastyIds: ["later-zhou", "northern-song"], roles: ["北宋建立者", "后周禁军将领"], roleCategories: ["ruler", "general"],
  ...
  {
    id: "zhao-pu", name: "赵普", birthYear: 922, deathYear: 992, dynastyIds: ["later-zhou", "northern-song"], roles: ["北宋宰相", "幕僚"], roleCategories: ["official"],
