...
export const personRelations: PersonRelation[] = [
  ...
  { id: "qian-chu-zhao-kuangyin", sourcePersonId: "qian-chu", targetPersonId: "zhao-kuangyin", type: "political", description: "钱俶奉北宋正朔，并出兵配合赵匡胤对南唐的战争；此边同时概括钱俶在太祖去世后继续奉宋的政治关系，按产品年代截至 979 年。", startYear: 960, endYear: 979, ...reviewed(["《宋史》卷四百八十《吴越钱氏》"]), ...transcript([6]) },
