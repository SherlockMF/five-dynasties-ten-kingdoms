...
export const personRelations: PersonRelation[] = [
  { id: "huang-chao-zhu-wen", sourcePersonId: "huang-chao", targetPersonId: "zhu-wen", type: "ruler-subject", description: "朱温早年参加黄巢军，882 年转而归降唐朝。", startYear: 878, endYear: 882, ...reviewed(["《资治通鉴》卷二百五十五至卷二百五十六《唐纪七十一至七十二》"]), ...transcript([1, 2]) },
  ...
  { id: "li-siyuan-shi-jingtang", sourcePersonId: "li-siyuan", targetPersonId: "shi-jingtang", type: "family", description: "石敬瑭是李嗣源的女婿和重要将领。", endYear: 933, ...reviewed(["《新五代史》卷八《晋本纪第八》"]), ...transcript([3, 4]) },
  ...
  { id: "shi-chonggui-du-chongwei", sourcePersonId: "shi-chonggui", targetPersonId: "du-chongwei", type: "ruler-subject", description: "杜重威是石重贵朝统率主力北伐的后晋大将。", startYear: 942, endYear: 946, ...reviewed(["《旧五代史》卷一百九《晋书·杜重威传》"]), ...transcript([5]) },
  ...
  { id: "liu-chong-liu-jiyuan", sourcePersonId: "liu-chong", targetPersonId: "liu-jiyuan", type: "family", description: "刘继元是刘崇外孙，后来继承北汉帝位。", ...reviewed(["《宋史》卷四百八十一《北汉刘氏》"]), ...historicalExtension() },
  ...
  { id: "zhao-guangyi-qian-chu", sourcePersonId: "zhao-guangyi", targetPersonId: "qian-chu", type: "ruler-subject", description: "978 年钱俶向宋太宗纳土，随后以宋臣身份保留爵位。", startYear: 978, endYear: 978, ...reviewed(["《续资治通鉴长编》卷十九", "《宋史》卷四百八十《吴越钱氏》"]), ...transcript([6]) },
  { id: "zhao-guangyi-liu-jiyuan", sourcePersonId: "zhao-guangyi", targetPersonId: "liu-jiyuan", type: "enemy", description: "979 年赵光义亲征北汉，刘继元守太原后出降。", startYear: 979, endYear: 979, ...reviewed(["《续资治通鉴长编》卷二十", "《宋史》卷四百八十一《北汉刘氏》"]), ...transcript([6]) },
  ...
  { id: "qian-chu-zhao-kuangyin", sourcePersonId: "qian-chu", targetPersonId: "zhao-kuangyin", type: "political", description: "钱俶奉北宋正朔，并出兵配合赵匡胤对南唐的战争。", startYear: 960, endYear: 976, ...reviewed(["《宋史》卷四百八十《吴越钱氏》"]), ...transcript([6]) },
...
export const dynastySuccessions: DynastySuccession[] = [
  ...
  { id: "later-han-northern-han", predecessorId: "later-han", successorId: "northern-han", note: "刘崇以河东军镇和后汉宗室身份延续汉号，并非继承中原全境。", ...reviewed(["《新五代史》卷七十《东汉世家第十》", "《宋史》卷四百八十一《北汉刘氏》"]), ...transcript([5, 6]) },
