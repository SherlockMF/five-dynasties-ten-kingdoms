...
export function DynastyListView({ dynasties, regions, onSelect }: { dynasties: Dynasty[]; regions: HistoricalRegion[]; onSelect: (id: string) => void }) {
  return (
