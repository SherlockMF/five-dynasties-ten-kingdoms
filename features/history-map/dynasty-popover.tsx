...
export function DynastyPopover({ dynasty, year, events, regions, onClose }: { dynasty: Dynasty; year: number; events: HistoricalEvent[]; regions: HistoricalRegion[]; onClose: () => void }) {
